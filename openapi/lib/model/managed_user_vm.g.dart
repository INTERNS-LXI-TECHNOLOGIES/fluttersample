...
Serializer<ManagedUserVM> _$managedUserVMSerializer =
    new _$ManagedUserVMSerializer();
...
class _$ManagedUserVMSerializer implements StructuredSerializer<ManagedUserVM> {
  ...
  @override
  final String wireName = 'ManagedUserVM';
  ...
  ManagedUserVM deserialize(
      ...
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ManagedUserVMBuilder();
...
class _$ManagedUserVM extends ManagedUserVM {
  ...
  factory _$ManagedUserVM([void Function(ManagedUserVMBuilder) updates]) =>
      (new ManagedUserVMBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('ManagedUserVM')
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'ManagedUserVM', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
