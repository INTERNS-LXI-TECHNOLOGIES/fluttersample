...
class BranchResourceApi {
    ...
    BranchResourceApi(this._dio, this._serializers);
        ...
        ///
        /// 
        Future<Response<List<BranchDTO>>>getAllBranchesUsingGET({ int page,int size,List<String> sort,CancelToken cancelToken, Map<String, String> headers,}) async {
        ...
        List<String> contentTypes = [];
            ...
            cancelToken: cancelToken,
                ...
                final FullType type = const FullType(BuiltList, const [const FullType(BranchDTO)]);
                BuiltList<BranchDTO> dataList = _serializers.deserialize(response.data is String ? jsonDecode(response.data) : response.data, specifiedType: type);
                var data = dataList.toList();

            return Response<List<BranchDTO>>(
                data: data,
                headers: response.headers,
                request: response.request,
                redirects: response.redirects,
